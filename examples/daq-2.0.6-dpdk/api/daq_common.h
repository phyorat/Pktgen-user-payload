...
#define DAQ_PKTCNT_OP_SET    5  /* User liked return value */
#define DAQ_PKTCNT_OP_DATA   4  /* User liked return value */
#define DAQ_PKTCNT_OP_NONE   3  /* User liked return value */
...
typedef int (*DAQ_Set_PktCnt_Filter)(void *args);

typedef enum __daq_pc_filter_req_type
{
    DAQ_PC_GET_DATA,
    DAQ_PC_GET_DATA_RTN,
    DAQ_PC_SET_FILTER,
    DAQ_PC_SET_FILTER_RTN,
    DAQ_PC_FILTER_INVALID,
    DAQ_PC_FILTER_INVALID_RTN
}daq_pc_filter_req_type;
