...
struct _daq_module
{
    ...
    int (*rsp_pc_filter) (void *handle, const void *pc_data, int datalen, DAQ_Set_PktCnt_Filter filter_cb);
    int (*req_pc_filter) (void *handle, void *filter_ptr, daq_pc_filter_req_type req_type);
